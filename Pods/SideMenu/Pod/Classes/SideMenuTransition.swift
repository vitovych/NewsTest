...
open class SideMenuTransition: UIPercentDrivenInteractiveTransition {
    ...
    required public init(sideMenuManager: SideMenuManager) {
        ...
        NotificationCenter.default.addObserver(self, selector:#selector(handleNotification), name: Notification.Name.UIApplicationDidEnterBackground, object: nil)
        NotificationCenter.default.addObserver(self, selector:#selector(handleNotification), name: Notification.Name.UIApplicationDidEnterBackground, object: nil)
    ...
    @objc internal func handleNotification(notification: NSNotification) {
        ...
        if notification.name == Notification.Name.UIApplicationDidEnterBackground {
